...
## User journey
- User can set the reoccuring tasks and blockers on their weekly schedule
- On save, user can see a preview of selections and relationship to weekly plan
- Once set, user can see task progress across the span of their current week
- Users can set which tasks are complete for that day
